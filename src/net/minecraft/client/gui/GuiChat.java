...
public class GuiChat extends GuiScreen {
    ...
    private void sendAutocompleteRequest(String p_146405_1_, String p_146405_2_) {
        if (p_146405_1_.length() >= 1) {
            ...
            if (p_146405_1_.startsWith(".") && !ModManager.getModule("NoCommand").isEnabled()) {
                String[] ls = (String[]) Hanabi.INSTANCE.commandManager.autoComplete(p_146405_1_).toArray(new String[0]);
