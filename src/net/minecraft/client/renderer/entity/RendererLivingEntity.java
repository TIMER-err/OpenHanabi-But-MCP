...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    private final boolean renderModelPushMatrix;
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        ...
        if (flag || flag1) {
            ...
            try {
                if (ModManager.getModule(ESP.class).isEnabled() && entitylivingbaseIn != Minecraft.getMinecraft().thePlayer && entitylivingbaseIn instanceof EntityPlayer) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            GL11.glTexEnvf(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_COLOR, this.brightnessBuffer.get());
    ...
    public void doRenderModel(T entitylivingbaseIn, float a, float b, float c, float d, float e, float scaleFactor) {
        this.renderModel(entitylivingbaseIn, a, b, c, d, e, scaleFactor);
    }

    public void doRenderLayers(T entitylivingbaseIn, float a, float b, float partialTicks, float d, float e, float f, float g) {
        this.renderLayers(entitylivingbaseIn, a, b, partialTicks, d, e, f, g);
    }
