...
public class PlayerControllerMP {
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        synchronized(playerIn.openContainer) {
            ...
            (Minecraft.getMinecraft().getNetHandler().getNetworkManager()).sendPacketNoEvent(new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, mode, itemstack, playerIn.openContainer.getNextTransactionID(playerIn.inventory)));
            return itemstack;
        }
    }
