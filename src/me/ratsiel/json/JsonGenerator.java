      ...
      if (value == null) {
         ...
         if (jsonHandler != null) {
            ...
            if (String.class.isAssignableFrom(clazz)) {
               ...
               JsonValue jsonValue1 = new JsonNumber();
               ((JsonNumber)jsonValue1).setValue(value.toString());
               return jsonValue1;
            } else if (Boolean.class.isAssignableFrom(clazz)) {
               JsonValue jsonValue2 = new JsonBoolean();
               ((JsonBoolean)jsonValue2).setValue((Boolean)value);
               return jsonValue2;
            } else {
               Iterator var18;
      ...
      if (jsonValue instanceof JsonString) {
         ...
         if (jsonValue instanceof JsonObject) {
            ...
            ((JsonArray)jsonValue).loop((integer, listValue) -> {
               list.add(this.fromJson((JsonValue) listValue, clazz));
            });
            return list;
         }
