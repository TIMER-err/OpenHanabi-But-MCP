...
public class ShaderLoader {
    ...
    public ShaderLoader update() {
        if (this.fboID != -1 && this.renderBufferID != -1 && this.programmId != -1) {
            ...
            ARBShaderObjects.glUniform1fARB(this.resolutionUniformId, resolutionBuffer.get());
            ...
            ARBShaderObjects.glUniform1fARB(this.texelUniformId, texelSizeBuffer.get());
            ...
            mouseBuffer.flip();
            ARBShaderObjects.glUniform1fARB(this.mouseUniformId, mouseBuffer.get());
