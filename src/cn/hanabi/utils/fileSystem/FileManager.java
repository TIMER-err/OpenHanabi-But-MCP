   ...
   public void load() {
      ...
      try {
         ...
         if (!keyFile.exists()) {
            ...
            br1 = new BufferedReader(new FileReader(keyFile));
         ...
         if (!gen.exists()) {
            ...
            br1 = new BufferedReader(new FileReader(gen));
            line = br1.readLine();
            if (GuiAltManager.Api == null) {
         ...
         if (!moduleFile.exists()) {
            ...
            br1 = new BufferedReader(new FileReader(moduleFile));
         ...
         if (!valueFile.exists()) {
            ...
            br1 = new BufferedReader(new FileReader(valueFile));
