...
public class PlayerUtil {
   ...
   public static boolean MovementInput() {
      return (mc.gameSettings.keyBindForward).getPress() || (mc.gameSettings.keyBindLeft).getPress() || (mc.gameSettings.keyBindRight).getPress() || (mc.gameSettings.keyBindBack).getPress();
   }
