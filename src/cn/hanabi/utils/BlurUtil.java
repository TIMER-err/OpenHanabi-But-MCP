...
public class BlurUtil {
   ...
   private static void setShaderConfigs(float intensity, float blurWidth, float blurHeight) {
      ((net.minecraft.client.shader.Shader)(blurShader).getShaders().get(0)).getShaderManager().getShaderUniform("Radius").set(intensity);
      ((net.minecraft.client.shader.Shader)(blurShader).getShaders().get(1)).getShaderManager().getShaderUniform("Radius").set(intensity);
      ((net.minecraft.client.shader.Shader)(blurShader).getShaders().get(0)).getShaderManager().getShaderUniform("BlurDir").set(blurWidth, blurHeight);
      ((net.minecraft.client.shader.Shader)(blurShader).getShaders().get(1)).getShaderManager().getShaderUniform("BlurDir").set(blurHeight, blurWidth);
   }
