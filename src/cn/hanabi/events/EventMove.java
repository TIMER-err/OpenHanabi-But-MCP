...
public class EventMove implements Event {
   ...
   public void setMovementSpeed(double movementSpeed) {
      this.setX(-(Math.sin((Minecraft.getMinecraft().thePlayer).getDirection()) * Math.max(movementSpeed, this.getMovementSpeed())));
      this.setZ(Math.cos((Minecraft.getMinecraft().thePlayer).getDirection()) * Math.max(movementSpeed, this.getMovementSpeed()));
   }
