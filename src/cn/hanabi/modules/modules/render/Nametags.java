...
public class Nametags extends Mod {
    ...
    private void updatePositions() {
        ...
        while (true) {
            ...
            double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double) pTicks - (mc.getRenderManager()).getRenderPosX();
            double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double) pTicks - (mc.getRenderManager()).getRenderPosY();
            double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double) pTicks - (mc.getRenderManager()).getRenderPosZ();
    ...
    private double[] convertTo2D(double x, double y, double z, Entity ent) {
        ...
        (Minecraft.getMinecraft().entityRenderer).runSetupCameraTransform(pTicks, 0);
