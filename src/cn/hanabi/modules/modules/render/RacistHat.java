...
public class RacistHat extends Mod {
   ...
   private void drawDoli(EntityLivingBase entity, EventRender evt) {
      double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double)evt.getPartialTicks() - (mc.getRenderManager()).getRenderPosX();
      double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double)evt.getPartialTicks() - (mc.getRenderManager()).getRenderPosY();
      double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double)evt.getPartialTicks() - (mc.getRenderManager()).getRenderPosZ();
