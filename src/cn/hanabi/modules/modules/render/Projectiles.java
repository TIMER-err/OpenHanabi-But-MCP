   ...
   public void onRender(EventRender event) {
      if (mc.thePlayer.inventory.getCurrentItem() != null) {
         ...
         if (item == 261 || item == 368 || item == 332 || item == 344) {
            ...
            GL11.glEnd();
            double renderX = posX - (mc.getRenderManager()).getRenderPosX();
            double renderY = posY - (mc.getRenderManager()).getRenderPosY();
            double renderZ = posZ - (mc.getRenderManager()).getRenderPosZ();
            GL11.glPushMatrix();
