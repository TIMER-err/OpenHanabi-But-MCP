...
public class ChestESP extends Mod {
   ...
   public void onRender(EventRender e) {
      BlockPos pos;
      for(Iterator var2 = this.list.iterator(); var2.hasNext(); RenderUtil.drawSolidBlockESP((double)pos.getX() - (mc.getRenderManager()).getRenderPosX(), (double)pos.getY() - (mc.getRenderManager()).getRenderPosY(), (double)pos.getZ() - (mc.getRenderManager()).getRenderPosZ(), 1.0F, 1.0F, 1.0F, 0.2F)) {
