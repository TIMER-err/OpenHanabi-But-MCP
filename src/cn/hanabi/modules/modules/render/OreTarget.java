...
public class OreTarget extends Mod {
   ...
   private void renderBlock(BlockPos pos) {
      double x = (double)pos.getX() - (this.mc.getRenderManager()).getRenderPosX();
      double y = (double)pos.getY() - (this.mc.getRenderManager()).getRenderPosY();
      double z = (double)pos.getZ() - (this.mc.getRenderManager()).getRenderPosZ();
      ...
      this.mc.entityRenderer.setupCameraTransform(Wrapper.getTimer().renderPartialTicks, 2);
