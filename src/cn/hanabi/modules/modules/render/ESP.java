   ...
   private void doOther2DESP() {
      ...
      while(var1.hasNext()) {
         ...
         if (this.isValid(entity)) {
            ...
            double x = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double)partialTicks - (mc.getRenderManager()).getRenderPosX();
            double y = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double)partialTicks - (mc.getRenderManager()).getRenderPosY();
            double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double)partialTicks - (mc.getRenderManager()).getRenderPosZ();
            float SCALE = 0.035F;
            SCALE /= 2.0F;
            float xMid = (float)x;
