...
public class ModManager {
    public static @NotNull List<Mod> modules = new ArrayList<>();
    ...
    public static @NotNull List<Mod> getModules() {
    ...
    public static ArrayList getEnabledModListHUD() {
        ...
        enabledModList.sort((o1, o2) -> {
            return (int) ((((Mod) o2).getDisplayName() != null ? (float) (font.getStringWidth(((Mod) o2).getDisplayName()) + 3 + font.getStringWidth(((Mod) o2).getName())) : ((Mod) o2).namewidth) - (((Mod) o1).getDisplayName() != null ? (float) (font.getStringWidth(((Mod) o1).getDisplayName()) + 3 + font.getStringWidth(((Mod) o1).getName())) : ((Mod) o1).namewidth));
        });
    ...
    public static List<Mod> getModList() {
        ...
        Iterator<Mod> var1 = modules.iterator();
