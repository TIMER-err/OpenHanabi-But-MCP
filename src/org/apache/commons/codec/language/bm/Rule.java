            ...
            if (startsWithBox && endsWithBox) {
                ...
                if (!boxContent.contains("[")) {
                    ...
                    if (startsWith && endsWith) {
                        ...
                        return input -> input.length() == 1 && Rule.contains(finalBoxContent, input.charAt(0)) == shouldMatch;
                    }

                    if (startsWith) {
                        String finalBoxContent1 = boxContent;
                        return input -> input.length() > 0 && Rule.contains(finalBoxContent1, input.charAt(0)) == shouldMatch;
                    }
