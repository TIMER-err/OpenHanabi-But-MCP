...
public final class EventManager {
    private static final Map<Class<?>, CopyOnWriteArrayList<MethodData>> REGISTRY_MAP = new HashMap<>();
    ...
    public static void unregister(Object object, Class<?> eventClass) {
        if (REGISTRY_MAP.containsKey(eventClass)) {
            ((List<MethodData>) REGISTRY_MAP.get(eventClass)).removeIf((data) -> {
